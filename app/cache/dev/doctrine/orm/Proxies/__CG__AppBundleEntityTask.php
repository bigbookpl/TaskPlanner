...
class Task extends \AppBundle\Entity\Task implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'term', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'priority', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'category', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'comments', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'isDone'];
        }
